                            ...
                            <div class="col-xl-5 col-lg-6 col-md-7">
                                <div class="registration">
                                    ...
                                    <div class="social-btns-list" data-onsuccess="onSignIn">
										...
										<a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:9999/Project_SWP391/loginGoogleHandler&response_type=code&client_id=317266700784-kg2ivgn1cgkturjutcqgmkitdo1o5nl3.apps.googleusercontent.com&approval_prompt=force">Đăng Nhập Google</a>

...
<!--                    <div class="sidebar-sign-logo">
                        <img style="height: 500px; width:  1000px;" src="${pageContext.request.contextPath}/image/icon/ve.jpg" alt="">
                    </div>-->
                                ...
                                <div class="registration">
                                    ...
                                    <div class="social-btns-list mb-lg-5">
                                        ...
                                        <button class="social-login-btn">
                                            ...
                                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/Project_SWP391/loginGoogleHandler&response_type=code&client_id=260351764288-fighfnvm17mondoe94g4g7cpntuc7jlt.apps.googleusercontent.com&approval_prompt=force">Sign In With Google</a>
                                        </button>
